    ...
    <div class="highlight-clean">
        <div class="container">
            <div class="intro">
                ...
                <p class="text-center">Add new faculties or View, Update and Delete Existing Faculties&nbsp;</p>
            </div>
            <div class="buttons"><a class="btn btn-primary" role="button" href="addfaculty.php">Add New Faculty</a><a class="btn btn-light" role="button" href='viewfaculty.php'>View All Faculties</a></div>
        </div>
    </div>
	<br>
	<br>
