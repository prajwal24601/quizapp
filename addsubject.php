...
if($_POST['subcode'] == "" || $_POST['subname'] == ""){
...
$sql = "INSERT INTO subject (scode, sname)
VALUES ('$_POST[subcode]', '$_POST[subname]')";
...
if ($conn->connect_error) {
 ...
 if(in_array($extension, $allowed_extension)) //check selected file extension is present in allowed extension array
 {
  ...
  foreach ($objPHPExcel->getWorksheetIterator() as $worksheet)
  {
   ...
   {
    $output .= "<tr>";
    $scode = mysqli_real_escape_string($conn, $worksheet->getCellByColumnAndRow(0, $row)->getValue());
    $sname = mysqli_real_escape_string($conn, $worksheet->getCellByColumnAndRow(1, $row)->getValue());
	 
    $query = "INSERT INTO subject(scode, sname) VALUES ('".$scode."', '".$sname."')";
  ...
  echo '<script>alert("Subjects in the Sheet Added Successfully")</script>';
  $output .= '</table>';
...
<body>
    ...
    <div class="contact-clean">
        <form method="post" enctype="multipart/form-data">
            <div class="form-group"><input class="form-control" type="text" name="subcode" placeholder="Subject Code"></div>
            <div class="form-group"><input class="form-control" type="text" name="subname" placeholder="Name"></div>
            <div class="form-group"><button class="btn btn-primary" type="submit" name="submit">ADD Subject</button></div><br><br>
			
			 <div class="form-group"><input type="file" name="excel" id="excel" accept=".xls,.xlsx">  &nbsp <button class="btn btn-primary" type="submit" name="import" id="import" >Import Subjects</button></div>
        </form>
    </div>
	<br>
	<br>
