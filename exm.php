    ...
    <div class="highlight-clean">
        <div class="container">
            <div class="intro">
                ...
                <p class="text-center">Add new Exam or View, Update and Delete Existing Exams</p>
            </div>
            <div class="buttons"><a class="btn btn-primary" role="button" href="addexam.php">set New Exam</a><a class="btn btn-light" role="button" href='viewexam.php'>View existing Exam</a></div>
        </div>
    </div>
	<br>
	<br>
