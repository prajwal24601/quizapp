...
{
if($_POST['searchusn'] == "" ){	
$result = mysqli_query($conn, "SELECT * from student where year='$_POST[year]'");
while($row = mysqli_fetch_array($result))
					{
						...
						echo "<td>";
							...
							echo "<div class='buttons'><a class='btn btn-light' role='button' href='deletestudent.php?usn=$res1'>Delete</a></div>";
							echo "</button>";
							echo "</div>";
	...
	$result = mysqli_query($conn, "SELECT * from student where usn='$_POST[searchusn]'");
while($row = mysqli_fetch_array($result))
					{
						echo "<tr>";
						echo "<td>" . $row['usn'] . "</td>";
