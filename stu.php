    ...
    <div class="highlight-clean">
        <div class="container">
            <div class="intro">
                ...
                <p class="text-center">Add new Students or View, Update and Delete Existing Faculties&nbsp;</p>
            </div>
            <div class="buttons"><a class="btn btn-primary" role="button" href="addstudent.php">Add New Student</a><a class="btn btn-light" role="button" href='viewstudent.php'>View All Students</a></div>
        </div>
    </div>
	<br>
	<br>
